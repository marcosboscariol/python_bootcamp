...
"""
temperaturas = [17, 20, 28]

for index, values in enumerate(temperaturas):
    if temperaturas[index] < 18:
        print(f"A temperatura {temperaturas[index]} é menor ou igual que 17")
    elif temperaturas[index] <= 26:
        print(f"A temperatura {temperaturas[index]} é menor ou igual que 26")
    else:
        print(f"A temperatura {temperaturas[index]} é maior que 26")
"""
...
try:
    ...
    if "@" not in email:
        ...
        print(f"Sua idade é {idade} e seu e-mail é {email}")
...
min_lista = min(lista_numeros)

lista_normalizada = []

for n in lista_numeros:
    a = n - min_lista / (max_lista - min_lista)
